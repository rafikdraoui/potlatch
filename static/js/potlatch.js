...
var _rafikdraoui$potlatch$Utils$isValidCharForSlug = function (c) {
	return _elm_lang$core$Char$isLower(c) || (_elm_lang$core$Char$isDigit(c) || _elm_lang$core$Native_Utils.eq(
		c,
		_elm_lang$core$Native_Utils.chr('-')));
};
var _rafikdraoui$potlatch$Utils$slugify = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'-',
		A2(
			...
			A2(
				_elm_lang$core$List$map,
				_elm_lang$core$String$filter(_rafikdraoui$potlatch$Utils$isValidCharForSlug),
				_elm_lang$core$String$words(
					_elm_lang$core$String$toLower(str)))));
};
var _rafikdraoui$potlatch$Utils$nullOr = function (decoder) {
...
var _rafikdraoui$potlatch$Utils$splitInGroupsOf = F2(
	function (n, xs) {
		if ((_elm_lang$core$Native_Utils.cmp(n, 1) < 0) || _elm_lang$core$List$isEmpty(xs)) {
			return _elm_lang$core$Native_List.fromArray(
				[]);
		} else {
			var rest = A2(_elm_lang$core$List$drop, n, xs);
			var prefix = A2(_elm_lang$core$List$take, n, xs);
			return A2(
				_elm_lang$core$List_ops['::'],
				prefix,
				A2(_rafikdraoui$potlatch$Utils$splitInGroupsOf, n, rest));
		}
	});

var _rafikdraoui$potlatch$Model$Item = F4(
	function (a, b, c, d) {
		return {name: a, description: b, image: c, taken: d};
	});
var _rafikdraoui$potlatch$Model$items = function () {
	var item = A5(
		_elm_lang$core$Json_Decode$object4,
		_rafikdraoui$potlatch$Model$Item,
		A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string),
		A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'description',
			_rafikdraoui$potlatch$Utils$nullOr(_elm_lang$core$Json_Decode$string)),
		A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'image',
			_rafikdraoui$potlatch$Utils$nullOr(_elm_lang$core$Json_Decode$string)),
...
var _rafikdraoui$potlatch$Model$FetchSuccess = function (a) {
	return {ctor: 'FetchSuccess', _0: a};
};
var _rafikdraoui$potlatch$Model$fetchItems = function (url) {
	var task = A2(
		_evancz$elm_http$Http$get,
		A2(_elm_lang$core$Json_Decode_ops[':='], 'items', _rafikdraoui$potlatch$Model$items),
		url);
	return A3(_elm_lang$core$Task$perform, _rafikdraoui$potlatch$Model$FetchFailure, _rafikdraoui$potlatch$Model$FetchSuccess, task);
};
var _rafikdraoui$potlatch$Model$init = function (_p1) {
	var _p2 = _p1;
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_rafikdraoui$potlatch$Model$fetchItems(_p2.itemsUrl)
			]));
};

var _rafikdraoui$potlatch$View$viewFooter = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Made by '),
					A2(
					_elm_lang$html$Html$a,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$href('http://www.rafik.ca')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Rafik Draoui')
						])),
					_elm_lang$html$Html$text(' using '),
					A2(
					_elm_lang$html$Html$a,
					_elm_lang$core$Native_List.fromArray(
						[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Source code available on '),
					A2(
					_elm_lang$html$Html$a,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$href('https://github.com/rafikdraoui/potlatch')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
	...
	return imgContainer(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('u-max-full-width'),
...
var _rafikdraoui$potlatch$View$viewItem = function (item) {
	var description = A2(_elm_lang$core$Maybe$withDefault, '', item.description);
	var name = A2(_elm_lang$core$Basics_ops['++'], item.name, '!');
	var itemId = _rafikdraoui$potlatch$Utils$slugify(item.name);
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('one-half column')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$id(itemId),
						_elm_lang$html$Html_Attributes$classList(
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'item', _1: true},
								{ctor: '_Tuple2', _0: 'taken', _1: item.taken}
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_rafikdraoui$potlatch$View$viewImage(item)
					]))
			]));
};
var _rafikdraoui$potlatch$View$viewRow = function (row) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Already taken')
					])),
				_rafikdraoui$potlatch$View$viewItemsSection(taken)
			]));
};
var _rafikdraoui$potlatch$View$viewError = function (err) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('An error occured when fetching items')
					])),
				A2(
				_elm_lang$html$Html$p,
				_elm_lang$core$Native_List.fromArray(
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Loading items...')
							]))
					]));
		case 'Error':
...
var _rafikdraoui$potlatch$View$viewHeader = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Potlatch')
				])),
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('A (virtual) gift-giving feast')
				])),
			A2(
			_elm_lang$html$Html$p,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('I will leave Toronto at the end of June to go travel around the world! I  want to get rid of most of my belongings so that what\'s left can fit in a car.')
				])),
			A2(
			_elm_lang$html$Html$p,
			_elm_lang$core$Native_List.fromArray(
...
var _rafikdraoui$potlatch$View$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_rafikdraoui$potlatch$View$viewHeader,
				A2(
				_elm_lang$html$Html$hr,
				_elm_lang$core$Native_List.fromArray(
					[]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				_rafikdraoui$potlatch$View$viewBody(model),
				A2(
				_elm_lang$html$Html$hr,
				_elm_lang$core$Native_List.fromArray(
					[]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				_rafikdraoui$potlatch$View$viewFooter
			]));
};

var _rafikdraoui$potlatch$Main$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{
			init: _rafikdraoui$potlatch$Model$init,
			update: _rafikdraoui$potlatch$Model$update,
			subscriptions: function (_p0) {
				return _elm_lang$core$Platform_Sub$none;
			},
			view: _rafikdraoui$potlatch$View$view
		}),
	flags: A2(
		_elm_lang$core$Json_Decode$andThen,
		A2(_elm_lang$core$Json_Decode_ops[':='], 'itemsUrl', _elm_lang$core$Json_Decode$string),
		function (itemsUrl) {
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _rafikdraoui$potlatch$Main$main === 'undefined' ? null : _rafikdraoui$potlatch$Main$main);
